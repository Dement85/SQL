...
--    FOREIGN KEY (TableID) REFERENCES Tables_rest(TableID),
...
-- INSERT INTO Restaurant (RestaurantID, Name_rest, Address, Phone)
-- VALUES
...
-- INSERT INTO Tables_rest (TableID, RestaurantID, Capacity, IsAvailable)
-- VALUES
--    (1, 1, 4, true),
--    (2, 1, 6, true),
--    (3, 2, 8, true),
...
-- INSERT INTO Customers (CustomerID, Name_cl, Email, Phone)
-- VALUES
...
-- INSERT INTO Waiters (WaiterID, Name_w, RestaurantID)
-- VALUES
--    (1, 'Mark Thompson', 1),
--    (2, 'Sarah Johnson', 2),
--    (3, 'Chris Brown', 3),
